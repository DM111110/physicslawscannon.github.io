...
let cannonSfx = new Audio("https://ia803405.us.archive.org/1/items/metal-block/Anti%20Aircraft%20Cannon-18363-Free-Loops.com.mp3");
...
class Cannon {
    ...
    rotateTop() {
        if(mousePos) {
            ...
            ctx.translate((this.x+14), (this.y-50));
            ctx.rotate(angle); 
...
class CannonBall {
    constructor(angle, x, y){
        ...
        this.elasticity = 0.5;
        this.friction = 0.008;
        this.collAudio = new Audio("https://ia903405.us.archive.org/28/items/metal-block_202104/metal-block.wav");
...
function ballHittWall(ball) {
    if(ball.x + ball.radius > 580 || ball.x - ball.radius < 20 || ball.y + ball.radius > 580 || ball.y - ball.radius < 20) {
        if(ball.timeDiff1) {
...
function collideBalls(ball1, ball2) {
    ...
    ball2.dy += (impulse * ball2.mass * vCollisionNorm.y);
